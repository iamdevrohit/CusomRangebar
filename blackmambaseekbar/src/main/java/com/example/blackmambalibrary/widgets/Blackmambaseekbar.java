...
import com.example.blackmambalibrary.interfaces.OnSeekbarChangeListener;
import com.example.blackmambalibrary.interfaces.OnSeekbarFinalValueListener;

public class Blackmambaseekbar extends View {
    ...
    public Blackmambaseekbar(Context context) {
        this(context, null);
    }

    public Blackmambaseekbar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Blackmambaseekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        // prevent render is in edit mode
        if (isInEditMode()) return;

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.Stylebalckmambaseekbar);
        try {
    ...
    public Blackmambaseekbar setCornerRadius(float cornerRadius) {
        this.cornerRadius = cornerRadius;
        return this;
    }

    public Blackmambaseekbar setMinValue(float minValue) {
        this.minValue = minValue;
        this.absoluteMinValue = minValue;
        return this;
    }

    public Blackmambaseekbar setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public Blackmambaseekbar setMinStartValue(float minStartValue) {
        this.minStartValue = minStartValue;
        return this;
    }

    public Blackmambaseekbar setSteps(float steps) {
        this.steps = steps;
        return this;
    }

    public Blackmambaseekbar setBarHeight(float barHeight) {
        this._barHeight = barHeight;
        return this;
    }

    public Blackmambaseekbar setBarColorMode(int barColorMode) {
        this.barColorMode = barColorMode;
        return this;
    }

    public Blackmambaseekbar setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public Blackmambaseekbar setBarGradientStart(int barGradientStart) {
        this.barGradientStart = barGradientStart;
        return this;
    }

    public Blackmambaseekbar setBarGradientEnd(int barGradientEnd) {
        this.barGradientEnd = barGradientEnd;
        return this;
    }

    public Blackmambaseekbar setBarHighlightColorMode(int barHighlightColorMode) {
        this.barHighlightColorMode = barHighlightColorMode;
        return this;
    }

    public Blackmambaseekbar setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public Blackmambaseekbar setBarHighlightGradientStart(int barHighlightGradientStart) {
        this.barHighlightGradientStart = barHighlightGradientStart;
        return this;
    }

    public Blackmambaseekbar setBarHighlightGradientEnd(int barHighlightGradientEnd) {
        this.barHighlightGradientEnd = barHighlightGradientEnd;
        return this;
    }

    public Blackmambaseekbar setThumbColor(int leftThumbColorNormal) {
        this.thumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public Blackmambaseekbar setThumbHighlightColor(int leftThumbColorPressed) {
        this.thumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public Blackmambaseekbar setThumbDrawable(int resId) {
        setThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public Blackmambaseekbar setThumbDrawable(Drawable drawable) {
        setThumbBitmap(getBitmap(drawable));
        return this;
    }

    public Blackmambaseekbar setThumbBitmap(Bitmap bitmap) {
        thumb = bitmap;
        return this;
    }

    public Blackmambaseekbar setThumbHighlightDrawable(int resId) {
        setThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public Blackmambaseekbar setThumbHighlightDrawable(Drawable drawable) {
        setThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public Blackmambaseekbar setThumbHighlightBitmap(Bitmap bitmap) {
        thumbPressed = bitmap;
        return this;
    }

    public Blackmambaseekbar setDataType(int dataType) {
        this.dataType = dataType;
        return this;
    }

    public Blackmambaseekbar setPosition(int pos) {
    ...
    public float getDiameter(final TypedArray typedArray) {
        return typedArray.getDimensionPixelSize(R.styleable.Stylebalckmambaseekbar_thumb_diameter, getResources().getDimensionPixelSize(R.dimen.thumb_height));
    }

    protected boolean isSeekBarTouchEnabled(final TypedArray typedArray){
        return typedArray.getBoolean(R.styleable.Stylebalckmambaseekbar_seek_bar_touch_enabled, false);
    }
    ...
    protected float getCornerRadius(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.Stylebalckmambaseekbar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.Stylebalckmambaseekbar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.Stylebalckmambaseekbar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.Stylebalckmambaseekbar_min_start_value, minValue);
    }

    protected float getSteps(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.Stylebalckmambaseekbar_steps, NO_STEP);
    }

    protected float getBarHeight(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(R.styleable.Stylebalckmambaseekbar_bar_height, 10);
    }

    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.Stylebalckmambaseekbar_bar_color_mode, ColorMode.SOLID);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_bar_color, Color.GRAY);
    }

    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_bar_gradient_start, Color.GRAY);
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_bar_gradient_end, Color.DKGRAY);
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.Stylebalckmambaseekbar_bar_highlight_color_mode, ColorMode.SOLID);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_bar_highlight_color, Color.BLACK);
    }

    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_bar_highlight_gradient_start, Color.DKGRAY);
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_bar_highlight_gradient_end, Color.BLACK);
    }

    protected int getThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_thumb_color, Color.BLACK);
    }

    protected int getThumbColorPressed(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.Stylebalckmambaseekbar_thumb_color_pressed, Color.DKGRAY);
    }

    protected Drawable getThumbDrawable(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.Stylebalckmambaseekbar_thumb_image);
    }

    protected Drawable getThumbDrawablePressed(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.Stylebalckmambaseekbar_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.Stylebalckmambaseekbar_data_type, DataType.INTEGER);
    }

    protected final int getPosition(final TypedArray typedArray) {
        final int pos = typedArray.getInt(R.styleable.Stylebalckmambaseekbar_position, Position.LEFT);
