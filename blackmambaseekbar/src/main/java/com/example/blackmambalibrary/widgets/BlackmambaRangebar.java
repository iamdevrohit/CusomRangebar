package com.example.blackmambalibrary.widgets;
...
import com.example.blackmambalibrary.R;
import com.example.blackmambalibrary.interfaces.OnRangeSeekbarChangeListener;
import com.example.blackmambalibrary.interfaces.OnRangeSeekbarFinalValueListener;
...
public class BlackmambaRangebar extends View {
    ...
    public BlackmambaRangebar(Context context) {
        this(context, null);
    }

    public BlackmambaRangebar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BlackmambaRangebar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        if(isInEditMode()) return;

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.StyleRangeSeekbar);
        try{
    ...
    public BlackmambaRangebar setCornerRadius(float cornerRadius){
        this.cornerRadius = cornerRadius;
        return this;
    }

    public BlackmambaRangebar setMinValue(float minValue){
        this.minValue = minValue;
        this.absoluteMinValue = minValue;
        return this;
    }

    public BlackmambaRangebar setMaxValue(float maxValue){
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public BlackmambaRangebar setMinStartValue(float minStartValue){
        this.minStartValue = minStartValue;
        this.absoluteMinStartValue = minStartValue;
        return this;
    }

    public BlackmambaRangebar setMaxStartValue(float maxStartValue){
        this.maxStartValue = maxStartValue;
        this.absoluteMaxStartValue = maxStartValue;
        return this;
    }

    public BlackmambaRangebar setSteps(float steps){
        this.steps = steps;
        return this;
    }

    public BlackmambaRangebar setGap(float gap){
        this.gap = gap;
        return this;
    }

    public BlackmambaRangebar setFixGap(float fixGap){
        this.fixGap = fixGap;
        return this;
    }

    public BlackmambaRangebar setBarHeight(float height) {
        _barHeight = height;
        return this;
    }

    public BlackmambaRangebar setBarColorMode(int barColorMode) {
        this.barColorMode = barColorMode;
        return this;
    }

    public BlackmambaRangebar setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public BlackmambaRangebar setBarGradientStart(int barGradientStart) {
        this.barGradientStart = barGradientStart;
        return this;
    }

    public BlackmambaRangebar setBarGradientEnd(int barGradientEnd) {
        this.barGradientEnd = barGradientEnd;
        return this;
    }

    public BlackmambaRangebar setBarHighlightColorMode(int barHighlightColorMode) {
        this.barHighlightColorMode = barHighlightColorMode;
        return this;
    }

    public BlackmambaRangebar setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public BlackmambaRangebar setBarHighlightGradientStart(int barHighlightGradientStart) {
        this.barHighlightGradientStart = barHighlightGradientStart;
        return this;
    }

    public BlackmambaRangebar setBarHighlightGradientEnd(int barHighlightGradientEnd) {
        this.barHighlightGradientEnd = barHighlightGradientEnd;
        return this;
    }

    public BlackmambaRangebar setLeftThumbColor(int leftThumbColorNormal){
        this.leftThumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public BlackmambaRangebar setLeftThumbHighlightColor(int leftThumbColorPressed){
        this.leftThumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public BlackmambaRangebar setLeftThumbDrawable(int resId){
        setLeftThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public BlackmambaRangebar setLeftThumbDrawable(Drawable drawable){
        setLeftThumbBitmap(getBitmap(drawable));
        return this;
    }

    public BlackmambaRangebar setLeftThumbBitmap(Bitmap bitmap){
        leftThumb = bitmap;
        return this;
    }

    public BlackmambaRangebar setLeftThumbHighlightDrawable(int resId){
        setLeftThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public BlackmambaRangebar setLeftThumbHighlightDrawable(Drawable drawable){
        setLeftThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public BlackmambaRangebar setLeftThumbHighlightBitmap(Bitmap bitmap){
        leftThumbPressed = bitmap;
        return this;
    }

    public BlackmambaRangebar setRightThumbColor(int rightThumbColorNormal){
        this.rightThumbColorNormal = rightThumbColorNormal;
        return this;
    }

    public BlackmambaRangebar setRightThumbHighlightColor(int rightThumbColorPressed){
        this.rightThumbColorPressed = rightThumbColorPressed;
        return this;
    }

    public BlackmambaRangebar setRightThumbDrawable(int resId){
        setRightThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public BlackmambaRangebar setRightThumbDrawable(Drawable drawable){
        setRightThumbBitmap(getBitmap(drawable));
        return this;
    }

    public BlackmambaRangebar setRightThumbBitmap(Bitmap bitmap){
        rightThumb = bitmap;
        return this;
    }

    public BlackmambaRangebar setRightThumbHighlightDrawable(int resId){
        setRightThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public BlackmambaRangebar setRightThumbHighlightDrawable(Drawable drawable){
        setRightThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public BlackmambaRangebar setRightThumbHighlightBitmap(Bitmap bitmap){
        rightThumbPressed = bitmap;
        return this;
    }

    public BlackmambaRangebar setDataType(int dataType){
    ...
    protected float getCornerRadius(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_min_start_value, minValue);
    }

    protected float getMaxStartValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_max_start_value, maxValue);
    }

    protected float getSteps(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_steps, NO_STEP);
    }

    protected float getGap(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_gap, 0f);
    }

    protected float getFixedGap(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.StyleRangeSeekbar_fix_gap, NO_FIXED_GAP);
    }

    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.StyleRangeSeekbar_bar_color_mode, Blackmambaseekbar.ColorMode.SOLID);
    }

    protected float getBarHeight(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(R.styleable.StyleRangeSeekbar_bar_height, 0);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_bar_color, Color.GRAY);
    }

    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_bar_gradient_start, Color.GRAY);
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_bar_gradient_end, Color.DKGRAY);
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.StyleRangeSeekbar_bar_highlight_color_mode, Blackmambaseekbar.ColorMode.SOLID);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_bar_highlight_color, Color.BLACK);
    }

    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_bar_highlight_gradient_start, Color.DKGRAY);
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_bar_highlight_gradient_end, Color.BLACK);
    }

    protected int getLeftThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_left_thumb_color, Color.BLACK);
    }

    protected int getRightThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_right_thumb_color, Color.BLACK);
    }

    protected int getLeftThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_left_thumb_color_pressed, Color.DKGRAY);
    }

    protected int getRightThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.StyleRangeSeekbar_right_thumb_color_pressed, Color.DKGRAY);
    }

    protected Drawable getLeftDrawable(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.StyleRangeSeekbar_left_thumb_image);
    }

    protected Drawable getRightDrawable(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.StyleRangeSeekbar_right_thumb_image);
    }

    protected Drawable getLeftDrawablePressed(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.StyleRangeSeekbar_left_thumb_image_pressed);
    }

    protected Drawable getRightDrawablePressed(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.StyleRangeSeekbar_right_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray){
        return typedArray.getInt(R.styleable.StyleRangeSeekbar_data_type, DataType.INTEGER);
    }

    protected boolean isSeekBarTouchEnabled(final TypedArray typedArray){
        return typedArray.getBoolean(R.styleable.StyleRangeSeekbar_seek_bar_touch_enabled, false);
    }

    protected float getDiameter(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(R.styleable.StyleRangeSeekbar_thumb_diameter, getResources().getDimensionPixelSize(R.dimen.thumb_height));
    }
    ...
    protected void setupBar(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        if (barColorMode == Blackmambaseekbar.ColorMode.SOLID) {
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        if (barHighlightColorMode == Blackmambaseekbar.ColorMode.SOLID) {
